...
class CLDNNModel:
  ...
  def loss(self):
    ...
    #ctc = tf.reduce_mean(tf.nn.ctc_loss(inference_time_major, self.sparse_output, self.output_lengths_placeholder, time_major = True))
...
# For testing purpose
  ...
  summary_base_path = '/tmp/custom/CLDNN/logs/'
